...
const SimpleAvailClient = require('./simple-avail-client');
...
class AvailIndexer {
  ...
  async initialize() {
    try {
      ...
      this.availClient = new SimpleAvailClient(
        config.avail.rpcUrl,
      ...
      console.log('🚀 Avail Indexer initialized');
...
// Main execution
async function main() {
  console.log('🌟 Avail Blockchain Indexer v1.0.0');
  console.log('=====================================\n');
  
  // Create and run indexer
  const indexer = new AvailIndexer();
